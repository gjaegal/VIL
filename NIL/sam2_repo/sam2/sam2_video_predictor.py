...
from sam2_repo.sam2.modeling.sam2_base import NO_OBJ_SCORE, SAM2Base
from sam2_repo.sam2.utils.misc import concat_points, fill_holes_in_mask_scores, load_video_frames
...
class SAM2VideoPredictor(SAM2Base):
    ...
    def _get_image_feature(self, inference_state, frame_idx, batch_size):
        ...
        if backbone_out is None:
            ...
            device = inference_state["device"]
            frame_idx = min(frame_idx, inference_state["images"].shape[0] - 1)
